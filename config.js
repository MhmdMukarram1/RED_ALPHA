...
module.exports = {
    VERSION: 'v7.3.6',
    CHANNEL: 'https://chat.whatsapp.com/Jx7f5x3wSU7D8a9ntdFB3j',
    ...
    OA_NAME: process.env.DEPLOYER === undefined ? 'Mhmd Mukarram' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙʏ яє∂ αℓρнα' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://i.ibb.co/XpKLnJb/mhm.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Red_Alpha' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '•━━━━Red Alpha━━━•' : process.env.BOT_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'Red Alpha' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.ibb.co/XpKLnJb/mhm.jpg' : process.env.ALL_IMG,
    SKDL: process.env.DIALOGUE === undefined ? 'No More' : process.env.DIALOGUE,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'alpha/🃏/🌈/⚠️/📝' : process.env.CMD_LIST,
