...
Asena.addCommand({pattern: 'setvar', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    r_text[0] = "https://i.ibb.co/XpKLnJb/mhm.jpg";
...
All setvars are
 ...
 .setvar TAG_REPPLY:your jid 
     ...
     *happy using RedAlpha bot ❣️*

*Editing And Devaloper : MhmdMukarram -RedAlpha*

*Erorr Fixing : MhmdMukarram -RedAlpha 💌*

*Supporting : MhmdMukarram -RedAlpha 💌*

*User Support : MhmdMukarram ✨️*
