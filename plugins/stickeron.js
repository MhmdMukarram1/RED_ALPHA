...
Julie.addCommand({ pattern: 'emoji ?(.*)', fromMe: true, desc: 'changes list command and emojies', usage: '.emoji *list/💌/🍃/🍒/🍿*' }, (async (message, match) => {
    ...
    Julie.addCommand({ pattern: 'caption ?(.*)', fromMe: true, desc: 'changes all captions', usage: '.caption *Made by RedAlpha*' }, (async (message, match) => {
    ...
    Julie.addCommand({ pattern: 'number ?(.*)', fromMe: true, desc: 'change user number', usage: '.number *Made by RedAlpha*' }, (async (message, match) => {
    ...
    Julie.addCommand({ pattern: 'deployer ?(.*)', fromMe: true, desc: 'change user name', usage: '.deployer *Made by RedAlpha*' }, (async (message, match) => {
